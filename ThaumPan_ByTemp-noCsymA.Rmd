...
MesoMAO = taxkey[which(taxkey$Taxa_Short != "CsymA" & taxkey$Type_Temp == "meso" & taxkey$Type_AO == "AO" | taxkey$Taxa_Short != "CsymA" & taxkey$Type_Temp == "modthermo" & taxkey$Type_AO == "AO"), 1]
...
uniqueCsub = getunique(pangenome_clean, taxlistCsub$r_yes, setdiff(taxlistCsub$r_no, which(rownames(pangenome_clean) == "CsymA") ))

sharedThFn1 = sharedgroups(pangenome_clean, taxlistThFn1$r_yes)
uniqueThFn1 = getunique(pangenome_clean, taxlistThFn1$r_yes, setdiff(taxlistThFn1$r_no, which(rownames(pangenome_clean) == "CsymA")))

sharedThAOA = sharedgroups(pangenome_clean, taxlistThAOA$r_yes)
uniqueThAOA = getunique(pangenome_clean, taxlistThAOA$r_yes, setdiff(taxlistThAOA$r_no, which(rownames(pangenome_clean) == "CsymA")))


sharedMesoMAO = sharedgroups(pangenome_clean, taxlistMesoMAO$r_yes)
uniqueMesoMAO = getunique(pangenome_clean, taxlistMesoMAO$r_yes, setdiff(taxlistMesoMAO$r_no, which(rownames(pangenome_clean) == "CsymA")))
...
pdf('rplots/temp-strict_noCsymA.pdf')
...
pdf('rplots/temp-soft_noCsymA.pdf')
...
pdf('rplots/temp-atleastone_noCsymA.pdf')
...
cCsub_core_C = getcounts(nCsub_core_C, categories, thaumtab_noCsym) 
cThFn1_core_C = getcounts(nThFn1_core_C, categories, thaumtab_noCsym) 
cThAOA_core_C = getcounts(nThAOA_core_C, categories, thaumtab_noCsym) 
cMesoMAO_core_C = getcounts(nMesoMAO_core_C, categories, thaumtab_noCsym) 
...
# number of annotations
cCsub_core_F = getcounts(nCsub_core_F, categories, thaumtab_noCsym) 
cThFn1_core_F = getcounts(nThFn1_core_F, categories, thaumtab_noCsym) 
cThAOA_core_F = getcounts(nThAOA_core_F, categories, thaumtab_noCsym) 
cMesoMAO_core_F = getcounts(nMesoMAO_core_F, categories, thaumtab_noCsym) 
...
cCoreOne_all = getcounts(coreOne_all, categories, thaumtab_noCsym)
names(cCoreF_all) = c(categories, "NA")

# number of annotations
cCsub_one = getcounts(nCsub_one, categories, thaumtab_noCsym) 
cThFn1_one = getcounts(nThFn1_one, categories, thaumtab_noCsym) 
cThAOA_one = getcounts(nThAOA_one, categories, thaumtab_noCsym) 
cMesoMAO_one = getcounts(nMesoMAO_one, categories, thaumtab_noCsym) 
...
cMesoALL_lin_C = getcounts(nMesoALL_lin_C, categories, thaumtab_noCsym)
...
cMesoMAO_lin_C = getcounts(nMesoMAO_lin_C, categories, thaumtab_noCsym)
...
cThermoALL_lin_C = getcounts(nThermoALL_lin_C, categories, thaumtab_noCsym)
...
cThAOA_lin_C = getcounts(nThAOA_lin_C, categories, thaumtab_noCsym)
...
cMesoALL_lin_F = getcounts(nMesoALL_lin_F, categories, thaumtab_noCsym)
...
cMesoMAO_lin_F = getcounts(nMesoMAO_lin_F, categories, thaumtab_noCsym)
...
cThermoALL_lin_F = getcounts(nThermoALL_lin_F, categories, thaumtab_noCsym)
...
cThAOA_lin_F = getcounts(nThAOA_lin_F, categories, thaumtab_noCsym)
...
cMesoALL_lin_one = getcounts(nMesoALL_lin_one, categories, thaumtab_noCsym)
...
cMesoMAO_lin_one = getcounts(nMesoMAO_lin_one, categories, thaumtab_noCsym)
...
cThermoALL_lin_one = getcounts(nThermoALL_lin_one, categories, thaumtab_noCsym)
...
cThAOA_lin_one = getcounts(nThAOA_lin_one, categories, thaumtab_noCsym)
