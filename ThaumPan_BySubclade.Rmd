...
nitrosopumilales = taxkey[which(taxkey$Type_Taxa == "nitrosopumilales"),1]
...
uniqueNitrosopumilales = getunique(pangenome_clean, taxlistNitrosopumilales$r_yes, taxlistNitrosopumilales$r_no)

sharedNitrososphaerales = sharedgroups(pangenome_clean, taxlistNitrososphaerales$r_yes)
uniqueNitrososphaerales = getunique(pangenome_clean, taxlistNitrososphaerales$r_yes, taxlistNitrososphaerales$r_no)

sharedNitrosotaleales = sharedgroups(pangenome_clean, taxlistNitrosotaleales$r_yes)
uniqueNitrosotaleales = getunique(pangenome_clean, taxlistNitrosotaleales$r_yes, taxlistNitrosotaleales$r_no)

sharedNitrosocaldales = sharedgroups(pangenome_clean, taxlistNitrosocaldales$r_yes)
uniqueNitrosocaldales = getunique(pangenome_clean, taxlistNitrosocaldales$r_yes, taxlistNitrosocaldales$r_no)

sharedgroupI1c = sharedgroups(pangenome_clean, taxlistgroupI1c$r_yes)
uniquegroupI1c = getunique(pangenome_clean, taxlistgroupI1c$r_yes, taxlistgroupI1c$r_no)
...
pdf('rplots/venn_subclade-strict_CsymA.pdf')
...
pdf('rplots/venn_subclade-soft_CsymA.pdf')
...
pdf('rplots/venn_subclade-atleastone_CsymA.pdf')
...
nNitrosopumilales_core_C = gsub(".faa", "", names(sharedNitrosopumilales$yes_strict)) # 774
nNitrosotaleales_core_C = gsub(".faa", "", names(sharedNitrosotaleales$yes_strict)) #1276
nNitrososphaerales_core_C = gsub(".faa", "", names(sharedNitrososphaerales$yes_strict)) # 1080
nNitrosocaldales_core_C = gsub(".faa", "", names(sharedNitrosocaldales$yes_strict)) # 1118
...
cNitrosopumilales_core_C = getcounts(nNitrosopumilales_core_C, categories, thaumtab) # 799
cNitrosotaleales_core_C = getcounts(nNitrosotaleales_core_C, categories, thaumtab) # 1322
cNitrososphaerales_core_C = getcounts(nNitrososphaerales_core_C, categories, thaumtab) # 1116
cNitrosocaldales_core_C = getcounts(nNitrosocaldales_core_C, categories, thaumtab) # 1158
cGroupI1c_core_C = getcounts(nGroupI1c_core_C, categories, thaumtab) # 1764
```

### SUBCLADE CORE: SOFT
```{r}
# Subclade soft core - number of genes
nNitrosopumilales_core_F = gsub(".faa", "", names(sharedNitrosopumilales$yes_soft)) #1019
nNitrosotaleales_core_F = gsub(".faa", "", names(sharedNitrosotaleales$yes_soft)) # 1514
nNitrososphaerales_core_F = gsub(".faa", "", names(sharedNitrososphaerales$yes_soft)) # 1184
nNitrosocaldales_core_F = gsub(".faa", "", names(sharedNitrosocaldales$yes_soft)) # 1191
nGroupI1c_core_F = gsub(".faa", "", names(sharedgroupI1c$yes_strict)) # 1733 there is only one taxon is this group!!
...
cNitrosopumilales_core_F = getcounts(nNitrosopumilales_core_F, categories, thaumtab) #1054
cNitrosotaleales_core_F = getcounts(nNitrosotaleales_core_F, categories, thaumtab) #1570
cNitrososphaerales_core_F = getcounts(nNitrososphaerales_core_F, categories, thaumtab) #1229
cNitrosocaldales_core_F = getcounts(nNitrosocaldales_core_F, categories, thaumtab) #1235
cGroupI1c_core_F = getcounts(nGroupI1c_core_F, categories, thaumtab) #1764
```

# SUBCLADE - AT LEAST ONE
```{r}
# Subclade soft core - number of genes
nNitrosopumilales_one = gsub(".faa", "", names(sharedNitrosopumilales$yes_atleastone)) # 7154
nNitrosotaleales_one = gsub(".faa", "", names(sharedNitrosotaleales$yes_atleastone)) # 3054
nNitrososphaerales_one = gsub(".faa", "", names(sharedNitrososphaerales$yes_atleastone)) # 9339
nNitrosocaldales_one = gsub(".faa", "", names(sharedNitrosocaldales$yes_atleastone)) # 3319
nGroupI1c_one = gsub(".faa", "", names(sharedgroupI1c$yes_strict)) # 1733 there is only one taxon is this group!!
...
cOne_all = getcounts(one_all, categories, thaumtab)
names(cOne_all) = c(categories, "NA")

# Subclade soft core - number of annotations
cNitrosopumilales_one = getcounts(nNitrosopumilales_one, categories, thaumtab) # 7251
cNitrosotaleales_one = getcounts(nNitrosotaleales_one, categories, thaumtab) # 3128
cNitrososphaerales_one = getcounts(nNitrososphaerales_one, categories, thaumtab) # 9414
cNitrosocaldales_one = getcounts(nNitrosocaldales_one, categories, thaumtab) # 3374
cGroupI1c_one = getcounts(nGroupI1c_one, categories, thaumtab) #1764
```
...
# Counts
cNitrosopumilales_lin_C = getcounts(nNitrosopumilales_lin_C, categories, thaumtab)
cNitrosotaleales_lin_C = getcounts(nNitrosotaleales_lin_C, categories, thaumtab)
cNitrososphaerales_lin_C = getcounts(nNitrososphaerales_lin_C, categories, thaumtab)
cNitrosocaldales_lin_C = getcounts(nNitrosocaldales_lin_C, categories, thaumtab)
cGroupI1c_lin_C = getcounts(nGroupI1c_lin_C, categories, thaumtab)
...
# Counts
cNitrosopumilales_lin_F = getcounts(nNitrosopumilales_lin_F, categories, thaumtab)
cNitrosotaleales_lin_F = getcounts(nNitrosotaleales_lin_F, categories, thaumtab)
cNitrososphaerales_lin_F = getcounts(nNitrososphaerales_lin_F, categories, thaumtab)
cNitrosocaldales_lin_F = getcounts(nNitrosocaldales_lin_F, categories, thaumtab)
cGroupI1c_lin_F = getcounts(nGroupI1c_lin_F, categories, thaumtab)
...
# Counts
cNitrosopumilales_lin_one = getcounts(nNitrosopumilales_lin_one, categories, thaumtab)
cNitrosotaleales_lin_one = getcounts(nNitrosotaleales_lin_one, categories, thaumtab)
cNitrososphaerales_lin_one = getcounts(nNitrososphaerales_lin_one, categories, thaumtab)
cNitrosocaldales_lin_one = getcounts(nNitrosocaldales_lin_one, categories, thaumtab)
cGroupI1c_lin_one = getcounts(nGroupI1c_lin_one, categories, thaumtab)
