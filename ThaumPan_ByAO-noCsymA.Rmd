...
Separate taxa by AO
```{r}
AO = taxkey[which(taxkey$Type_AO == "AO" & taxkey$Taxa_Short != "CsymA"),1]
...
uniqueAO = getunique(pangenome_clean, taxlistAO$r_yes, setdiff(taxlistAO$r_no, which(rownames(pangenome_clean) == "CsymA")))
...
pdf('rplots/AO-strict_noCsymA.pdf')
...
pdf('rplots/AO-soft_noCsymA.pdf')
...
pdf('rplots/AO-atleastone_noCsymA.pdf')
...
cAO_core_C = getcounts(nAO_core_C, categories, thaumtab_noCsym) 
...
cAO_core_F = getcounts(nAO_core_F, categories, thaumtab_noCsym) 
...
cAO_one = getcounts(nAO_one, categories, thaumtab_noCsym) 
...
cAO_lin_C = getcounts(nAO_lin_C, categories, thaumtab_noCsym)

# nonAO
antiAO_int_C = union(nThFn1_core_C, nCsub_core_C)
nAntiAO_lin_C = antiAO_int_C[!antiAO_int_C %in% nAO_core_C]
cAntiAO_lin_C = getcounts(nAntiAO_lin_C, categories, thaumtab_noCsym)
...
cAO_lin_F = getcounts(nAO_lin_F, categories, thaumtab_noCsym)

# nonAO
antiAO_int_F = union(nThFn1_core_F, nCsub_core_F)
nAntiAO_lin_F = antiAO_int_F[!antiAO_int_F %in% nAO_core_F]
cAntiAO_lin_F = getcounts(nAntiAO_lin_F, categories, thaumtab_noCsym)
...
cAO_lin_one = getcounts(nAO_lin_one, categories, thaumtab_noCsym)

# nonAO
antiAO_int_one = union(nThFn1_one, nCsub_one)
nAntiAO_lin_one = antiAO_int_one[!antiAO_int_one %in% nAO_one]
cAntiAO_lin_one = getcounts(nAntiAO_lin_one, categories, thaumtab_noCsym)
